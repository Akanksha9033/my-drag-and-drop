...
//   const [placedItems, setPlacedItems] = useState({});
//   const [shuffledDefinitions, setShuffledDefinitions] = useState([]);
//   const [attemptedItems, setAttemptedItems] = useState({});
...
//           <div className="quiz-content">
//             <div className="drag-container">
//               {quizData[currentQuestion].terms
//                 .filter((term) => !(attemptedItems[currentQuestion] || []).includes(term))
//                 .map((term, index) => (
//                   <DragItem key={index} term={term} handleDragStart={handleDragStart} />
//                 ))}
//             </div>
...
//             <>
//               {currentQuestion > 0 && (
//                 <button onClick={previousQuestion} className="prev-btn">
//                   Previous Question
//                 </button>
//               )}
